public class Product
{
    ...
    // Constructor
    public Product(char id, string name, decimal price, int group, int? multipackQuantity = null, char? multipackID = null, decimal? promotionalPrice = null, int? promotionThreshold = null)
    {
        ID = id;
        Name = name;
        Price = price;
